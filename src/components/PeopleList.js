...
class PeopleList extends React.Component {
  ...
  render() {
    ...
    return <div className="list">
      ...
      <Select label="Favorite Fruit" defaultValue={this.selectOptions[0]} options={this.selectOptions} onChange={(e)=> {
      ...
      <div className="list-contents">
        ...
        {
            people.map((single)=> {
              return <li key={single.id} id={single.id}>{single.name.first} {single.name.last}</li> 
            })
          } 
        </ul>
      </div>
